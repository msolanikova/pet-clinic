...
public interface PetMapper {
    ...
    PetModel toPetDto(sk.promark.petclinic.entity.Pet entity);

    List<PetModel> toPetDtos(List<sk.promark.petclinic.entity.Pet> entities);

    @Mapping(target = "petType", source = "animalType", qualifiedByName = "animalTypeToPetType")
    @Mapping(target = "owner", ignore = true)
    sk.promark.petclinic.entity.Pet toPetEntity(PetModel model, @Context PetTypeService petTypeService);
